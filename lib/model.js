...
Model.prototype.joinScope = function(name, relation, joinOptions) {
  this._joinScopes[name] = Object.assign({}, joinOptions, {_rel: relation}) 
}
...
Model.prototype.hasJoinThrough = function(name, rel1, rel2, fn) {
  this.joinScope(name, rel1, {
    [rel2]: true,
    _apply: util.compose(fn, docs => docs(rel2)),
    _optionsOn: rel2
  })
} 
